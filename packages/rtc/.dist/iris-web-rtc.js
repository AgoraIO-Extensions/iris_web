...
var irisWebCore = require('iris-web-core');
var NATIVE_RTC = require('@iris/web-rtc');
var AgoraRTC2 = require('agora-rtc-sdk-ng');
...
var NATIVE_RTC__namespace = /*#__PURE__*/_interopNamespace(NATIVE_RTC);
var AgoraRTC2__default = /*#__PURE__*/_interopDefault(AgoraRTC2);
...
var _AgoraConsole = class _AgoraConsole {
  static log(msg) {
    if (_AgoraConsole.logLevel >= NATIVE_RTC.LOG_LEVEL.LOG_LEVEL_INFO) {
      console.log("[Iris]:" + msg);
    }
  }
  static warn(msg) {
    if (_AgoraConsole.logLevel >= NATIVE_RTC.LOG_LEVEL.LOG_LEVEL_WARN) {
      console.warn("[Iris]:" + msg);
    }
  }
  static error(msg) {
    if (_AgoraConsole.logLevel >= NATIVE_RTC.LOG_LEVEL.LOG_LEVEL_ERROR) {
...
_AgoraConsole.logLevel = NATIVE_RTC.LOG_LEVEL.LOG_LEVEL_ERROR;
...
var AgoraTranslate = class _AgoraTranslate {
  static NATIVE_RTCLOG_LEVEL2Number(logLevel) {
    switch (logLevel) {
      case NATIVE_RTC__namespace.LOG_LEVEL.LOG_LEVEL_NONE:
        return 4;
      case NATIVE_RTC__namespace.LOG_LEVEL.LOG_LEVEL_INFO:
        return 1;
      case NATIVE_RTC__namespace.LOG_LEVEL.LOG_LEVEL_WARN:
        return 2;
      case NATIVE_RTC__namespace.LOG_LEVEL.LOG_LEVEL_ERROR:
        return 3;
      case NATIVE_RTC__namespace.LOG_LEVEL.LOG_LEVEL_FATAL:
        return 3;
      case NATIVE_RTC__namespace.LOG_LEVEL.LOG_LEVEL_API_CALL:
        return 0;
    }
  }
  static NATIVE_RTCAREA_CODE2AREAS(areaCode) {
    switch (areaCode) {
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_CN:
        return AgoraRTC2.AREAS.CHINA;
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_NA:
        return AgoraRTC2.AREAS.NORTH_AMERICA;
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_EU:
        return AgoraRTC2.AREAS.EUROPE;
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_AS:
        return AgoraRTC2.AREAS.ASIA;
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_JP:
        return AgoraRTC2.AREAS.JAPAN;
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_IN:
        return AgoraRTC2.AREAS.INDIA;
      case NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_GLOB:
        return AgoraRTC2.AREAS.GLOBAL;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_OC:
        return AgoraRTC2.AREAS.OCEANIA;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_SA:
        return AgoraRTC2.AREAS.SOUTH_AMERICA;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_AF:
        return AgoraRTC2.AREAS.AFRICA;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_KR:
        return AgoraRTC2.AREAS.KOREA;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_OC:
        return AgoraRTC2.AREAS.OCEANIA;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_HKMC:
        return AgoraRTC2.AREAS.HKMC;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_US:
        return AgoraRTC2.AREAS.US;
      case NATIVE_RTC__namespace.AREA_CODE_EX.AREA_CODE_OVS:
        return AgoraRTC2.AREAS.OVERSEA;
      default:
  ...
  static NATIVE_RTCCLIENT_ROLE_TYPE2ClientRole(clientRole) {
    switch (clientRole) {
      case NATIVE_RTC__namespace.CLIENT_ROLE_TYPE.CLIENT_ROLE_BROADCASTER:
        return "host";
      case NATIVE_RTC__namespace.CLIENT_ROLE_TYPE.CLIENT_ROLE_AUDIENCE:
        return "audience";
    }
  }
  static NATIVE_RTCCHANNEL_PROFILE_TYPE2SDK_MODE(channelProfile) {
    switch (channelProfile) {
      case NATIVE_RTC__namespace.CHANNEL_PROFILE_TYPE.CHANNEL_PROFILE_LIVE_BROADCASTING:
        return "live";
      default:
        return "rtc";
    }
  ...
  static NATIVE_RTCClientRoleOptions2ClientRoleOptions(options) {
    switch (options.audienceLatencyLevel) {
      case NATIVE_RTC__namespace.AUDIENCE_LATENCY_LEVEL_TYPE.AUDIENCE_LATENCY_LEVEL_LOW_LATENCY:
        return { level: AgoraRTC2.AudienceLatencyLevelType.AUDIENCE_LEVEL_LOW_LATENCY };
      case NATIVE_RTC__namespace.AUDIENCE_LATENCY_LEVEL_TYPE.AUDIENCE_LATENCY_LEVEL_ULTRA_LOW_LATENCY:
        return {
          level: AgoraRTC2.AudienceLatencyLevelType.AUDIENCE_LEVEL_ULTRA_LOW_LATENCY
        };
    }
  }
  ...
  static NATIVE_RTCCONNECTION_STATE_TYPE2ConnectionState(state) {
    switch (state) {
      case NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_DISCONNECTED:
        return "DISCONNECTED";
      case NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_CONNECTING:
        return "CONNECTING";
      case NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_CONNECTED:
        return "CONNECTED";
      case NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_RECONNECTING:
        return "RECONNECTING";
      case NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_FAILED:
        return "DISCONNECTED";
    }
  }
  static NATIVE_RTCENCRYPTION_MODE2EncryptionMode(mode) {
    switch (mode) {
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_XTS:
        return "aes-128-xts";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_ECB:
        return "aes-128-ecb";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_256_XTS:
        return "aes-256-xts";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.SM4_128_ECB:
        return "sm4-128-ecb";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_GCM:
        return "aes-128-gcm";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_256_GCM:
        return "aes-256-gcm";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_GCM2:
        return "aes-128-gcm2";
      case NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_256_GCM2:
        return "aes-256-gcm2";
    }
  }
  ...
  static NATIVE_RTCChannelMediaRelayConfiguration2IChannelMediaRelayConfiguration(config) {
    let ret = AgoraRTC2__default.default.createChannelMediaRelayConfiguration();
  ...
  static NATIVE_RTCContentInspectConfig2InspectConfiguration(config) {
    ...
    if (config.modules.length > 0) {
      ...
      switch (module.type) {
        case NATIVE_RTC__namespace.CONTENT_INSPECT_TYPE.CONTENT_INSPECT_INVALID:
          break;
        case NATIVE_RTC__namespace.CONTENT_INSPECT_TYPE.CONTENT_INSPECT_MODERATION:
          ret.inspectType.push("moderation");
          break;
        case NATIVE_RTC__namespace.CONTENT_INSPECT_TYPE.CONTENT_INSPECT_SUPERVISION:
  ...
  static NATIVE_RTCVIDEO_CONTENT_HINT2string(hint) {
    switch (hint) {
      case NATIVE_RTC__namespace.VIDEO_CONTENT_HINT.CONTENT_HINT_MOTION:
        return "motion";
      case NATIVE_RTC__namespace.VIDEO_CONTENT_HINT.CONTENT_HINT_DETAILS:
        return "detail";
      default:
        return "detail";
    }
  ...
  static NATIVE_RTCCAMERA_DIRECTION2string(direction) {
    switch (direction) {
      case NATIVE_RTC__namespace.CAMERA_DIRECTION.CAMERA_FRONT:
        return "user";
      case NATIVE_RTC__namespace.CAMERA_DIRECTION.CAMERA_REAR:
        return "environment";
    }
  }
  static NATIVE_RTCVIDEO_MIRROR_MODE_TYPE2boolean(mode) {
    switch (mode) {
      case NATIVE_RTC__namespace.VIDEO_MIRROR_MODE_TYPE.VIDEO_MIRROR_MODE_AUTO:
        return true;
      case NATIVE_RTC__namespace.VIDEO_MIRROR_MODE_TYPE.VIDEO_MIRROR_MODE_DISABLED:
        return false;
      case NATIVE_RTC__namespace.VIDEO_MIRROR_MODE_TYPE.VIDEO_MIRROR_MODE_ENABLED:
        return true;
    }
  }
  static NATIVE_RTCVIDEO_CODEC_TYPE2SDK_CODEC(code) {
    switch (code) {
      case NATIVE_RTC__namespace.VIDEO_CODEC_TYPE.VIDEO_CODEC_H264:
        return "h264";
      case NATIVE_RTC__namespace.VIDEO_CODEC_TYPE.VIDEO_CODEC_AV1:
        return "av1";
      case NATIVE_RTC__namespace.VIDEO_CODEC_TYPE.VIDEO_CODEC_VP8:
        return "vp8";
      case NATIVE_RTC__namespace.VIDEO_CODEC_TYPE.VIDEO_CODEC_VP9:
        return "vp9";
      default:
        return "vp8";
    }
  ...
  static NATIVE_RTCVIDEO_STREAM_TYPE2RemoteStreamType(type) {
    switch (type) {
      case NATIVE_RTC__namespace.VIDEO_STREAM_TYPE.VIDEO_STREAM_HIGH:
        return AgoraRTC2.RemoteStreamType.HIGH_STREAM;
      case NATIVE_RTC__namespace.VIDEO_STREAM_TYPE.VIDEO_STREAM_LOW:
        return AgoraRTC2.RemoteStreamType.LOW_STREAM;
    }
  }
  static NATIVE_RTCSTREAM_FALLBACK_OPTIONS2RemoteStreamFallbackType(fallback) {
    switch (fallback) {
      case NATIVE_RTC__namespace.STREAM_FALLBACK_OPTIONS.STREAM_FALLBACK_OPTION_DISABLED:
        return AgoraRTC2.RemoteStreamFallbackType.DISABLE;
      case NATIVE_RTC__namespace.STREAM_FALLBACK_OPTIONS.STREAM_FALLBACK_OPTION_VIDEO_STREAM_LOW:
        return AgoraRTC2.RemoteStreamFallbackType.LOW_STREAM;
      case NATIVE_RTC__namespace.STREAM_FALLBACK_OPTIONS.STREAM_FALLBACK_OPTION_AUDIO_ONLY:
        return AgoraRTC2.RemoteStreamFallbackType.AUDIO_ONLY;
    }
  }
  ...
  static DeviceState2NATIVE_RTCMEDIA_DEVICE_STATE_TYPE(state) {
    switch (state) {
      case "ACTIVE":
        return NATIVE_RTC__namespace.MEDIA_DEVICE_STATE_TYPE.MEDIA_DEVICE_STATE_ACTIVE;
      case "INACTIVE":
        return NATIVE_RTC__namespace.MEDIA_DEVICE_STATE_TYPE.MEDIA_DEVICE_STATE_DISABLED;
    }
  }
  static ConnectionState2NATIVE_RTCCONNECTION_STATE_TYPE(state) {
    switch (state) {
      case "DISCONNECTED":
        return NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_DISCONNECTED;
      case "CONNECTING":
        return NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_CONNECTING;
      case "CONNECTED":
        return NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_CONNECTED;
      case "RECONNECTING":
        return NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_RECONNECTING;
      case "DISCONNECTING":
        return NATIVE_RTC__namespace.CONNECTION_STATE_TYPE.CONNECTION_STATE_DISCONNECTED;
    }
  }
  static string2NATIVE_RTCENCRYPTION_MODE(mode) {
    switch (mode) {
      case "aes-128-xts":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_XTS;
      case "aes-128-ecb":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_ECB;
      case "aes-256-xts":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_256_XTS;
      case "sm4-128-ecb":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.SM4_128_ECB;
      case "aes-128-gcm":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_GCM;
      case "aes-256-gcm":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_256_GCM;
      case "aes-128-gcm2":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_128_GCM2;
      case "aes-256-gcm2":
        return NATIVE_RTC__namespace.ENCRYPTION_MODE.AES_256_GCM2;
      default:
  ...
  static ConnectionDisconnectedReason2NATIVE_RTCCONNECTION_CHANGED_REASON_TYPE(reason) {
    switch (reason) {
      case AgoraRTC2.ConnectionDisconnectedReason.LEAVE:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_LEAVE_CHANNEL;
      case AgoraRTC2.ConnectionDisconnectedReason.NETWORK_ERROR:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_INTERRUPTED;
      case AgoraRTC2.ConnectionDisconnectedReason.SERVER_ERROR:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_INTERRUPTED;
      case AgoraRTC2.ConnectionDisconnectedReason.UID_BANNED:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_BANNED_BY_SERVER;
      case AgoraRTC2.ConnectionDisconnectedReason.IP_BANNED:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_BANNED_BY_SERVER;
      case AgoraRTC2.ConnectionDisconnectedReason.CHANNEL_BANNED:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_INVALID_CHANNEL_NAME;
      case AgoraRTC2.ConnectionDisconnectedReason.FALLBACK:
        return NATIVE_RTC__namespace.CONNECTION_CHANGED_REASON_TYPE.CONNECTION_CHANGED_INTERRUPTED;
    }
  }
  static string2NATIVE_RTCUSER_OFFLINE_REASON_TYPE(reason) {
    switch (reason) {
      case "Quit":
        return NATIVE_RTC__namespace.USER_OFFLINE_REASON_TYPE.USER_OFFLINE_QUIT;
      case "ServerTimeOut":
        return NATIVE_RTC__namespace.USER_OFFLINE_REASON_TYPE.USER_OFFLINE_DROPPED;
      case "BecomeAudience":
        return NATIVE_RTC__namespace.USER_OFFLINE_REASON_TYPE.USER_OFFLINE_BECOME_AUDIENCE;
      default:
        return NATIVE_RTC__namespace.USER_OFFLINE_REASON_TYPE.USER_OFFLINE_QUIT;
    }
  }
  static ChannelMediaRelayState2NATIVE_RTCCHANNEL_MEDIA_RELAY_STATE(state) {
    switch (state) {
      case AgoraRTC2.ChannelMediaRelayState.RELAY_STATE_IDLE:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_IDLE;
      case AgoraRTC2.ChannelMediaRelayState.RELAY_STATE_CONNECTING:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_CONNECTING;
      case AgoraRTC2.ChannelMediaRelayState.RELAY_STATE_RUNNING:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_RUNNING;
      case AgoraRTC2.ChannelMediaRelayState.RELAY_STATE_FAILURE:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE;
    }
  }
  static ChannelMediaRelayError2NATIVE_RTCCHANNEL_MEDIA_RELAY_ERROR(err) {
    switch (err) {
      case AgoraRTC2.ChannelMediaRelayError.RELAY_OK:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_ERROR.RELAY_OK;
      case AgoraRTC2.ChannelMediaRelayError.SERVER_CONNECTION_LOST:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_ERROR.RELAY_ERROR_SERVER_CONNECTION_LOST;
      case AgoraRTC2.ChannelMediaRelayError.SRC_TOKEN_EXPIRED:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_ERROR.RELAY_ERROR_SRC_TOKEN_EXPIRED;
      case AgoraRTC2.ChannelMediaRelayError.DEST_TOKEN_EXPIRED:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_ERROR.RELAY_ERROR_DEST_TOKEN_EXPIRED;
    }
  }
  static ChannelMediaRelayEvent2NATIVE_RTCCHANNEL_MEDIA_RELAY_EVENT(event) {
    switch (event) {
      case AgoraRTC2.ChannelMediaRelayEvent.NETWORK_DISCONNECTED:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_NETWORK_DISCONNECTED;
      case AgoraRTC2.ChannelMediaRelayEvent.NETWORK_CONNECTED:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_NETWORK_CONNECTED;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_JOINED_SRC_CHANNEL:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_JOINED_SRC_CHANNEL;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_JOINED_DEST_CHANNEL:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_JOINED_DEST_CHANNEL;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_SENT_TO_DEST_CHANNEL:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_SENT_TO_DEST_CHANNEL;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_RECEIVED_VIDEO_FROM_SRC:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_RECEIVED_VIDEO_FROM_SRC;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_RECEIVED_AUDIO_FROM_SRC:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_RECEIVED_AUDIO_FROM_SRC;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_UPDATE_DEST_CHANNEL:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_UPDATE_DEST_CHANNEL_REFUSED:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_REFUSED;
      case AgoraRTC2.ChannelMediaRelayEvent.PACKET_UPDATE_DEST_CHANNEL_NOT_CHANGE:
        return NATIVE_RTC__namespace.CHANNEL_MEDIA_RELAY_EVENT.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_NOT_CHANGE;
    }
  }
  ...
  static data2NATIVE_RTCCONTENT_INSPECT_RESULT(data) {
    switch (data) {
      case "porn":
        return NATIVE_RTC__namespace.CONTENT_INSPECT_RESULT.CONTENT_INSPECT_PORN;
      case "sexy":
        return NATIVE_RTC__namespace.CONTENT_INSPECT_RESULT.CONTENT_INSPECT_SEXY;
      case "neutral":
        return NATIVE_RTC__namespace.CONTENT_INSPECT_RESULT.CONTENT_INSPECT_NEUTRAL;
    }
  }
};
...
var IMediaEngineImpl = class {
  ...
  registerVideoEncodedFrameObserver(observer) {
    ...
    return -NATIVE_RTC__namespace.ERROR_CODE_TYPE.ERR_NOT_SUPPORTED;
  }
...
var IrisAgoraEventHandler = class {
  constructor(engine) {
    this._engine = engine;
    AgoraRTC2__default.default.onAutoplayFailed = this.onAutoplayFailed.bind(this);
    AgoraRTC2__default.default.onCameraChanged = this.onCameraChanged.bind(this);
    AgoraRTC2__default.default.onMicrophoneChanged = this.onMicrophoneChanged.bind(this);
    AgoraRTC2__default.default.onPlaybackDeviceChanged = this.onMicrophoneChanged.bind(this);
  }
  onAutoplayFailed() {
    this._engine.rtcEngineEventHandler.onError(
      NATIVE_RTC__namespace.ERROR_CODE_TYPE.ERR_NOT_READY,
      "auto play failed"
    );
  }
  onCameraChanged(info) {
    let deviceId = info.device.deviceId;
    let deviceType = NATIVE_RTC__namespace.MEDIA_DEVICE_TYPE.VIDEO_CAPTURE_DEVICE;
  ...
  onMicrophoneChanged(info) {
    let deviceId = info.device.deviceId;
    let deviceType = NATIVE_RTC__namespace.MEDIA_DEVICE_TYPE.AUDIO_RECORDING_DEVICE;
    let deviceState = AgoraTranslate.DeviceState2NATIVE_RTCMEDIA_DEVICE_STATE_TYPE(
      info.state
    );
  ...
  onPlaybackDeviceChanged(info) {
    let deviceId = info.device.deviceId;
    let deviceType = NATIVE_RTC__namespace.MEDIA_DEVICE_TYPE.AUDIO_PLAYOUT_DEVICE;
    let deviceState = AgoraTranslate.DeviceState2NATIVE_RTCMEDIA_DEVICE_STATE_TYPE(
      info.state
    );
    this._engine.rtcEngineEventHandler.onAudioDeviceStateChanged(
  ...
  destruction() {
    AgoraRTC2__default.default.onAutoplayFailed = void 0;
    AgoraRTC2__default.default.onCameraChanged = void 0;
    AgoraRTC2__default.default.onMicrophoneChanged = void 0;
    AgoraRTC2__default.default.onPlaybackDeviceChanged = void 0;
  }
};
var IrisGlobalVariables = class {
  constructor() {
    this.appId = null;
    //initialize()
    this.areaCode = NATIVE_RTC__namespace.AREA_CODE.AREA_CODE_CN;
    ...
    this.mirrorMode = NATIVE_RTC__namespace.VIDEO_MIRROR_MODE_TYPE.VIDEO_MIRROR_MODE_ENABLED;
...
var IrisMainClientVariables = class {
  constructor() {
    ...
    this.videoSourceType = NATIVE_RTC__namespace.VIDEO_SOURCE_TYPE.VIDEO_SOURCE_CAMERA;
    //SetVideoEncoderConfiguration
    this.videoEncoderConfiguration = null;
    //是否开启大小流
    ...
    this.encryptionConfig = {
      enabled: false,
      config: new NATIVE_RTC__namespace.EncryptionConfig()
    };
...
var IrisRtcEngine = class {
  constructor(irisEventHandlerManager) {
    ...
    this.executor = new irisWebCore.CallApiExecutor(true);
  ...
  callIrisApi(apiParam) {
    ...
    if (obj) {
      ...
      if (callApiFun) {
        ...
        return -NATIVE_RTC__namespace.ERROR_CODE_TYPE.ERR_FAILED;
      }
    } else {
    ...
    return __async(this, null, function* () {
      ...
      if (obj) {
        ...
        if (callApiFun) {
          ...
          return new irisWebCore.CallIrisApiResult(
            -NATIVE_RTC__namespace.ERROR_CODE_TYPE.ERR_FAILED,
            ""
          );
        }
      }
...
exports.AgoraActionQueue = AgoraActionQueue;
exports.AgoraConsole = AgoraConsole;
exports.AgoraTool = AgoraTool;
exports.AgoraTranslate = AgoraTranslate;
exports.AgoraWrapper = AgoraWrapper;
exports.Container = Container;
exports.initIrisRtc = initIrisRtc;
Object.keys(irisWebCore).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return irisWebCore[k]; }
  });
});

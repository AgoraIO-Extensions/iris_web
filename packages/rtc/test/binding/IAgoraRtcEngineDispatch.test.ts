...
describe('IRtcEngineEventHandler', () => {
  ...
  test('RtcEngineEventHandler_onAudioRoutingChanged2 impl call', async () => {
    let eventHandler = new bindingAPI.IRtcEngineEventHandler(irisRtcEngine);
    jest.spyOn(eventHandler._engine.irisEventHandlerManager, 'notifyEvent');
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    eventHandler.onAudioRoutingChanged2(undefined, undefined);
    expect(
      eventHandler._engine.irisEventHandlerManager.notifyEvent
    ).toBeCalledTimes(0);
    expect(irisRtcEngine.returnResult).toBeCalledTimes(1);
  ...
  test('RtcEngineEventHandler_onPermissionGranted impl call', async () => {
    let eventHandler = new bindingAPI.IRtcEngineEventHandler(irisRtcEngine);
    jest.spyOn(eventHandler._engine.irisEventHandlerManager, 'notifyEvent');
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    eventHandler.onPermissionGranted(undefined);
    expect(
      eventHandler._engine.irisEventHandlerManager.notifyEvent
    ).toBeCalledTimes(0);
    expect(irisRtcEngine.returnResult).toBeCalledTimes(1);
...
describe('IRtcEngine', () => {
  ...
  test('RtcEngine_writeLog impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
    ...
    await IrisCore.callIrisApi(apiEnginePtr, apiParam);
    expect(
      irisRtcEngine.implDispatchesMap.get('RtcEngine')._impl?.writeLog
    ).toBeUndefined();
    expect(irisRtcEngine.returnResult).toBeCalledTimes(1);
    expect(irisRtcEngine.returnResult).toBeCalledWith(
      false,
  ...
  test('RtcEngine_adjustRecordingSignalVolume parameter', async () => {
    let nParam = {
      volume: undefined,
    };
    try {
  ...
  test('RtcEngine_adjustPlaybackSignalVolume parameter', async () => {
    let nParam = {
      volume: undefined,
    };
    try {
  ...
  test('RtcEngine_adjustUserPlaybackSignalVolume parameter', async () => {
    let nParam = {
      uid: undefined,
      volume: undefined,
    };
  ...
  test('RtcEngine_enableInEarMonitoring parameter', async () => {
    let nParam = {
      enabled: undefined,
  ...
  test('RtcEngine_setCameraStabilizationMode impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngine_isSupportPortraitCenterStage impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {};
  ...
  test('RtcEngine_enablePortraitCenterStage impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngine_setRemoteRenderRotation impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngine_createDataStream2 parameter', async () => {
    let nParam = {
      config: undefined,
    };
    try {
  ...
  test('RtcEngine_setAINSMode parameter', async () => {
    let nParam = {
      enabled: undefined,
      mode: undefined,
    };

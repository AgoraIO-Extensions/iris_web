...
export class IMediaEngineDispatch{
  ...
  setExternalVideoSource(
    ...
    if (encodedVideoOption === undefined) throw "encodedVideoOption is undefined";

    return this._impl.setExternalVideoSource(enabled,useTexture,sourceType,encodedVideoOption,);
  }
  ...
  setExternalAudioSource(
    ...
    return this._impl.setExternalAudioSource(enabled,sampleRate,channels,localPlayback,publish,);
  }
  ...
  pushEncodedVideoImage(
    ...
    return this._impl.pushEncodedVideoImage(imageBuffer,length,videoEncodedFrameInfo,videoTrackId,);
  }

...
export class IMediaPlayerSourceObserver {
  ...
  notifyEvent(param: EventParam): void {
    ...
    onPlayerSourceStateChanged(state:MEDIA_PLAYER_STATE,ec:MEDIA_PLAYER_ERROR,): void {
      ...
      AgoraConsole.log(`onPlayerSourceStateChanged eventParam ${JSON.stringify(eventParam)}`);
    ...
    onPositionChanged(position_ms:number,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPositionChanged eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onPlayBufferUpdated(playCachedBuffer:number,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPlayBufferUpdated eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onAgoraCDNTokenWillExpire(): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onAgoraCDNTokenWillExpire eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onPlayerSrcInfoChanged(from:SrcInfo ,to:SrcInfo ,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPlayerSrcInfoChanged eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onPlayerInfoUpdated(info:PlayerUpdatedInfo ,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPlayerInfoUpdated eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }

...
export class IBaseSpatialAudioEngineDispatch{
  ...
  updateSelfPosition(
    ...
    return this._impl.updateSelfPosition(position,axisForward,axisRight,axisUp,);
  }
  ...
  updateSelfPositionEx(
    ...
    return this._impl.updateSelfPositionEx(position,axisForward,axisRight,axisUp,connection,);
  }

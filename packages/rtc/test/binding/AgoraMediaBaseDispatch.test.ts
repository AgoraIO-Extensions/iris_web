...
export class IAudioFrameObserverBase {
  ...
  notifyEvent(param: EventParam): void {
    ...
    onRecordAudioFrame(channelId:string,audioFrame:AudioFrame,): void {
      let _obj = {
        channelId,audioFrame,
      };
      let _json = JSON.stringify(_obj);
      let _key = this.eventKey('onRecordAudioFrame');

      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onRecordAudioFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onPlaybackAudioFrame(channelId:string,audioFrame:AudioFrame,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPlaybackAudioFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onMixedAudioFrame(channelId:string,audioFrame:AudioFrame,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onMixedAudioFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onEarMonitoringAudioFrame(audioFrame:AudioFrame,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onEarMonitoringAudioFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
...
export class IAudioFrameObserver extends IAudioFrameObserverBase{
  ...
  notifyEvent(param: EventParam): void {
    ...
    onPlaybackAudioFrameBeforeMixing(channelId:string,uid:number,audioFrame:AudioFrame,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPlaybackAudioFrameBeforeMixing eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
...
export class IAudioSpectrumObserver {
  ...
  notifyEvent(param: EventParam): void {
    ...
    onLocalAudioSpectrum(data:AudioSpectrumData ,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onLocalAudioSpectrum eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }

    onRemoteAudioSpectrum(spectrums:UserAudioSpectrumInfo [],spectrumNumber:number,): void {
      let _obj = {
        spectrums,spectrumNumber,
      };
      let _json = JSON.stringify(_obj);
      let _key = this.eventKey('onRemoteAudioSpectrum');

      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onRemoteAudioSpectrum eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
...
export class IVideoEncodedFrameObserver {
  ...
  notifyEvent(param: EventParam): void {
    ...
    onEncodedVideoFrameReceived(uid:number,imageBuffer:Uint8Array,length:number,videoEncodedFrameInfo:EncodedVideoFrameInfo ,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onEncodedVideoFrameReceived eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
...
export class IVideoFrameObserver {
  ...
  notifyEvent(param: EventParam): void {
    ...
    onCaptureVideoFrame(sourceType:VIDEO_SOURCE_TYPE,videoFrame:VideoFrame,): void {
      let _obj = {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onCaptureVideoFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }

    onPreEncodeVideoFrame(sourceType:VIDEO_SOURCE_TYPE,videoFrame:VideoFrame,): void {
      let _obj = {
        sourceType,videoFrame,
      };
      let _json = JSON.stringify(_obj);
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onPreEncodeVideoFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }

    onMediaPlayerVideoFrame(videoFrame:VideoFrame,mediaPlayerId:number,): void {
      let _obj = {
        videoFrame,mediaPlayerId,
      };
      let _json = JSON.stringify(_obj);
      let _key = this.eventKey('onMediaPlayerVideoFrame');

      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onMediaPlayerVideoFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onRenderVideoFrame(channelId:string,remoteUid:number,videoFrame:VideoFrame,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onRenderVideoFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onTranscodedVideoFrame(videoFrame:VideoFrame,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onTranscodedVideoFrame eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
...
export class IMediaRecorderObserver {
  ...
  notifyEvent(param: EventParam): void {
    ...
    onRecorderStateChanged(channelId:string,uid:number,state:RecorderState,error:RecorderErrorCode,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onRecorderStateChanged eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }
    ...
    onRecorderInfoUpdated(channelId:string,uid:number,info:RecorderInfo ,): void {
      ...
      let eventParam = new EventParam(_key, _json, 0, '', [], [], 0);
      AgoraConsole.log(`onRecorderInfoUpdated eventParam ${JSON.stringify(eventParam)}`);
      this.notifyEvent(eventParam);
    }

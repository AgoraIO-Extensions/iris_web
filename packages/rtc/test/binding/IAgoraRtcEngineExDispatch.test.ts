...
describe('IRtcEngineEx', () => {
  ...
  test('RtcEngineEx_leaveChannelWithUserAccountEx_ccad422 impl call', async () => {
    jest
  ...
  test('RtcEngineEx_leaveChannelWithUserAccountEx_8bbe372 impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngineEx_adjustRecordingSignalVolumeEx_e84d10e parameter', async () => {
    let nParam = {
      volume: undefined,
      connection: undefined,
    };
  ...
  test('RtcEngineEx_adjustUserPlaybackSignalVolumeEx_adbd29c parameter', async () => {
    let nParam = {
      uid: undefined,
      volume: undefined,
      connection: undefined,
  ...
  test('RtcEngineEx_enableAudioVolumeIndicationEx_ac84f2a parameter', async () => {
    let nParam = {
      interval: undefined,
      smooth: undefined,
      reportVad: undefined,
  ...
  test('RtcEngineEx_takeSnapshotEx_b856417 impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngineEx_enableVideoImageSourceEx_b63f346 impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngineEx_preloadEffectEx_c9fae88 impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {
  ...
  test('RtcEngineEx_playEffectEx_ae5345c impl call', async () => {
    jest
      .spyOn(irisRtcEngine, 'returnResult')
      .mockResolvedValue(new CallIrisApiResult(0, ''));
    let nParam = {

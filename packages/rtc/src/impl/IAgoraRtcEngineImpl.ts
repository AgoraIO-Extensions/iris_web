  ...
  joinChannel2(
    ...
    let processJoinChannel = async (): Promise<CallIrisApiResult> => {
      ...
      try {
        ...
        this._engine.mainClientVariables.isConnected = false;

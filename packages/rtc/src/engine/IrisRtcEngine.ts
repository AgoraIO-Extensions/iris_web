...
import { RtcEngineEventHandler } from "../binding/RtcEngineEventHandler";
...
import { IAudioDeviceManagerDispatch } from "../binding/event_dispatch/IAudioDeviceManagerDispatch";
...
import { ApiInterceptor, ApiInterceptorReturnType, ApiParam, CallApiExecutor, CallIrisApiResult, EventParam, IrisEventHandlerManager } from "iris-web-core";
...
export class IrisRtcEngine implements ApiInterceptor {
    ...
    public async callIrisApiAsync(apiParam: ApiParam): Promise<CallIrisApiResult> | undefined {
        let func_name = apiParam.event;
        // let params: string = apiParam.data;
        // let paramLength: number = apiParam.data_size;
        // let buffer: Array<any> = apiParam.buffer;

...
export interface IRtcEngine {
  ...
  setAudioMixingPlaybackSpeed_46f8ab7(speed: number): CallApiReturnType;
  ...
  enableCameraCenterStage_5039d15(enabled: boolean): CallApiReturnType;

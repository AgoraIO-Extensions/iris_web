...
import { MediaPlayerImpl } from '../../../../rtc/src/impl/MediaPlayerImpl';
...
import { IrisRtcEngine } from '../../../../rtc/src/engine/IrisRtcEngine';
import { MediaPlayerCacheManagerImpl } from '../../../../rtc/src/impl/MediaPlayerCacheManagerImpl';

export class IMediaPlayerCacheManagerDispatch {
  private _impl: IMediaPlayerCacheManager;

  constructor(engine: IrisRtcEngine) {
    this._impl = new MediaPlayerCacheManagerImpl(engine);
  }

...
interface IMediaPlayer {
    ...
    registerAudioFrameObserver(observer: IAudioPcmFrameSink, mode: RAW_AUDIO_FRAME_OP_MODE_TYPE): CallApiReturnType;
...
interface IRtcEngine {
    ...
    preloadChannel(token: string, channelId: string, userAccount: string): CallApiReturnType;
    ...
    joinChannel(token: string, channelId: string, uid: number, options: ChannelMediaOptions): CallApiReturnType;
    ...
    setClientRole(role: CLIENT_ROLE_TYPE, options: ClientRoleOptions): CallApiReturnType;
    ...
    startAudioRecording(filePath: string, sampleRate: number, quality: AUDIO_RECORDING_QUALITY_TYPE): CallApiReturnType;
    ...
    startAudioMixing(filePath: string, loopback: boolean, cycle: number, startPos: number): CallApiReturnType;
    ...
    enableDualStreamMode(enabled: boolean, streamConfig: SimulcastStreamConfig): CallApiReturnType;
    setDualStreamMode(mode: SIMULCAST_STREAM_MODE): CallApiReturnType;
    setDualStreamMode(mode: SIMULCAST_STREAM_MODE, streamConfig: SimulcastStreamConfig): CallApiReturnType;
    enableCustomAudioLocalPlayback(trackId: number, enabled: boolean): CallApiReturnType;
    ...
    enableExtension(provider: string, extension: string, extensionInfo: ExtensionInfo, enable: boolean): CallApiReturnType;
    ...
    setExtensionProperty(provider: string, extension: string, extensionInfo: ExtensionInfo, key: string, value: string): CallApiReturnType;
    getExtensionProperty(provider: string, extension: string, extensionInfo: ExtensionInfo, key: string, value: string, buf_len: number): CallApiReturnType;
    ...
    startScreenCapture(sourceType: VIDEO_SOURCE_TYPE, config: ScreenCaptureConfiguration): CallApiReturnType;
    ...
    createDataStream(streamId: number, config: DataStreamConfig): CallApiReturnType;
    ...
    addVideoWatermark(watermarkUrl: string, options: WatermarkOptions): CallApiReturnType;
    ...
    joinChannelWithUserAccount(token: string, channelId: string, userAccount: string, options: ChannelMediaOptions): CallApiReturnType;
...
interface IRtcEngineEx {
    ...
    leaveChannelEx(connection: RtcConnection, options: LeaveChannelOptions): CallApiReturnType;
    ...
    createDataStreamEx(streamId: number, config: DataStreamConfig, connection: RtcConnection): CallApiReturnType;

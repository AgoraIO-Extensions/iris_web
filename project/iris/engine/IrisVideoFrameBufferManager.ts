...
import { IrisCVideoFrameBuffer, IrisVideoFrameBufferConfig, IrisVideoFrameBufferDelegateHandle, Size, VideoParams } from "../base/BaseType";
...
export class IrisVideoFrameBufferManager {
    ...
    private _configMap: Map<string, VideoFrameBufferAndConf> = new Map<string, VideoFrameBufferAndConf>();
    ...
    public disableVideoFrameBufferByDelegate(handle: IrisVideoFrameBufferDelegateHandle) {
